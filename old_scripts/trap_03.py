...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.RandomErasing(p=0.5, scale=(0.02, 0.2)),  # Random erasing applied after converting to tensor
])
...
criterion = LabelSmoothingLoss(num_classes=num_classes, smoothing=0.1)  # Use Label Smoothing Loss
...
scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=10)  # Use Cosine Annealing Learning Rate Scheduler
